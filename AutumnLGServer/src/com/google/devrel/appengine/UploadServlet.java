...
public class UploadServlet extends HttpServlet {
	 ...
	 * reside in.
	 */
	public static final String GCS_BUCKET_NAME = "autumnlgdata1";
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		for (FileInfo fileInfo : fileInfos) {
			...
			Entity ent = new Entity("product",Integer.valueOf(id));
			ent.setUnindexedProperty("type", fileInfo.getContentType());
			ent.setUnindexedProperty("name", name);
			ent.setUnindexedProperty("price", price);
			ent.setUnindexedProperty("size", fileInfo.getSize());
			ent.setUnindexedProperty("picture", serveUrl.guessServingUrl(fileInfo));
	...
	protected void dispatchUploadForm(HttpServletRequest req, HttpServletResponse resp, String errorMsg) throws ServletException, IOException {
		...
		req.getRequestDispatcher("upload-form.jsp").forward(req, resp);
	}
